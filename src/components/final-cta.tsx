    ...
    <section className="px-6 py-8">
      <Reveal>
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] bg-[var(--color-secondary)] px-8 py-16 text-center sm:px-16 sm:py-20">
          <div className="pointer-events-none absolute inset-0 -z-0 bg-[radial-gradient(ellipse_60%_60%_at_50%_0%,rgba(56,189,248,0.25),transparent)]" />
          ...
          <div className="relative">
            ...
            <div className="mt-9">
              <a
                href="#contacto"
                className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-accent)] px-8 py-4 text-sm font-semibold text-white shadow-[0_20px_50px_-15px_rgba(56,189,248,0.6)] transition-transform hover:scale-[1.03]"
              >
                Quiero mi Página
